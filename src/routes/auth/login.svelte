...
<div class="min-h-screen flex flex-col justify-center items-center">
    <button
        ...
        type="button"
        class="text-gray-900 bg-white border border-gray-200  font-medium rounded-lg text-sm px-5 py-2 text-center inline-flex items-center mr-2 mb-2 space-x-2"
    >
        <svg
            id="Capa_1"
        ...
        <p class="font-medium">Login with Google</p>
    </button>
</div>
